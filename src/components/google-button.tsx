...
export function GoogleButton({
  ...
  return (
    <button
      ...
      className="flex h-11 w-full items-center justify-center gap-2.5 rounded-lg border bg-surface font-medium transition hover:bg-background disabled:opacity-60"
    >
      <GoogleIcon />
